[\[Paso Anterior\]](03_todo_content.md)

# Todo data base Helper

Esta clase basicamente sera un ORM (Object-Relational Mapping) esto nos ayudara a realizar insertar, actualizar y borrar `ToDos` en la base de datos de una forma limpia y sencilla donde sea que la queramos utilizar.

Creemos `ToDoDbHelper` con el siguiente contenido:
