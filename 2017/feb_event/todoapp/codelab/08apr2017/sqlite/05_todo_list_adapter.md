[\[Paso Anterior\]](04_todo_db_helper.md)

# ToDo List adapter

En este paso vamos a modificar `ToDoListAdapter` para agregar un metodo que nos permita actualizar la informacion ademas de corregir un pequeño bug que teniamos a la hora de actualizar los datos en nuestra vista.

Cambiemos el contenido de `ToDoListAdapter` por el siguiente:
...
Si intentamos correr la aplicacion en este punto esta no compilara en el siguiente paso vamos a resolver esto.

[\[Siguiente Paso\]](06_main_activity_refactor.md)
